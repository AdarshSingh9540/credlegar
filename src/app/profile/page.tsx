...
const EnhancedProfilePage = () => {
    const data = [
    {
      ...
      content: (
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
          <h3 className="text-xl font-semibold mb-2 text-teal-300">Software Engineer at TechCorp</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
            <h3 className="text-xl font-semibold mb-2 text-teal-300">Junior Developer at StartupX</h3>
            <Badge status="pending" />
            <p className="text-gray-400 text-sm mb-4">March 2023 - December 2023</p>
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                <span className="text-teal-400 mr-2">•</span>
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
            <h3 className="text-xl font-semibold mb-2 text-teal-300">Intern at CodeCrafters</h3>
            <Badge status="unverified" />
            <p className="text-gray-400 text-sm mb-4">January 2023 - March 2023</p>
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                <span className="text-teal-400 mr-2">•</span>
    ...
    },
    {
      ...
      content: (
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
          <h3 className="text-xl font-semibold mb-2 text-teal-300">Computer Science Student</h3>
          <p className="text-gray-400 text-sm mb-4">September 2022 - December 2022</p>
          <ul className="space-y-2 text-gray-300">
            <li className="flex items-start">
              <span className="text-teal-400 mr-2">•</span>
    ...
    },
    {
      ...
      content: (
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
          <h3 className="text-xl font-semibold mb-2 text-teal-300">Hackathon Winner</h3>
          <Badge status="verified" />
    ...
    },
    {
      ...
      content: (
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
          <h3 className="text-xl font-semibold mb-2 text-teal-300">High School Graduate</h3>
    ...
    },
    {
      ...
      content: (
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
          <h3 className="text-xl font-semibold mb-2 text-teal-300">Coding Competition Winner</h3>
          <Badge status="verified" />
    ...
    const certifications = [
  {
    ...
    content: (
      <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
        <h3 className="text-xl font-semibold mb-2 text-teal-300">React Developer Certification</h3>
        <Badge status="verified" />
        <p className="text-gray-400 text-sm mb-4">January 2024 - February 2024</p>
  ...
  },
  {
    ...
    content: (
      <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
        <h3 className="text-xl font-semibold mb-2 text-teal-300">Full-Stack Developer Certification</h3>
        <Badge status="verified" />
  ...
  },
  {
    ...
    content: (
      <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
        <h3 className="text-xl font-semibold mb-2 text-teal-300">Cloud Computing Certification</h3>
        <Badge status="verified" />
  ...
  },
  {
    ...
    content: (
      <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
        <h3 className="text-xl font-semibold mb-2 text-teal-300">DevOps Certification</h3>
        <Badge status="verified" />
  ...
  },
  {
    ...
    content: (
      <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
        <h3 className="text-xl font-semibold mb-2 text-teal-300">Data Science Certification</h3>
        <Badge status="verified" />
        <p className="text-gray-400 text-sm mb-4">September 2024 - October 2024</p>
